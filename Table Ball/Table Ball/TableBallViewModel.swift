...
//                let z = data.acceleration.z
    ...
    func resetGame() {
        ...
        if let boundSize = self.boundSize {
            ...
            tableBall.hole = randomHolePosition(in: boundSize)
        }
    ...
    func randomHolePosition (in boundSize: Vector2f) -> Vector2f {
        Vector2f(x: Double.random(in: tableBall.holeSize/2...boundSize.x-tableBall.holeSize/2), y: Double.random(in: tableBall.holeSize/2...boundSize.y-tableBall.holeSize/2))
    }
    ...
    enum BallState: Double { // raw value represents the frequency of radar sound
        case veayNear = 0.05
        case near = 0.1
        case close = 0.2
        case middle = 0.5
